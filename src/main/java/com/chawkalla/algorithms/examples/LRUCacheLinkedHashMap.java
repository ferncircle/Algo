...
public class LRUCacheLinkedHashMap {
	...
	public LRUCacheLinkedHashMap(int capacity) {
		...
		linkedMap=new LinkedMap(100, 0.75f, true);
	}
	...
	public class LinkedMap extends LinkedHashMap<Integer, Integer>{
		private static final long serialVersionUID = 5003441732005426587L;

		public LinkedMap(int capacity, float loadFactor, boolean accessOrder) {
	...
	public static void main(String[] args) {
		...
		cache=new LRUCacheLinkedHashMap(105);			
		...
		cache=new LRUCacheLinkedHashMap(10);		
