...
public class SearchRangeForDuplicate {
	...
	public static void main(String[] args) {
		...
		assertThat(new SearchRangeForDuplicate().searchRange(
		...
		assertThat(new SearchRangeForDuplicate().searchRange(
				IntStream.of(new int[]{5, 7, 7, 7, 7, 8, 8, 8, 8, 8, 8, 8}).boxed().collect(Collectors.toList()),
				8), is(new ArrayList<Integer>(Arrays.asList(new Integer[]{5, 11}))));
