 ...
 *
 */
public class WordSearchInBoardBFS {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(new WordSearchInBoardBFS().findWords(board, listOfWords.toArray(new String[listOfWords.size()])));
		System.out.println("Time taken="+(System.currentTimeMillis()-before));
		
		
		before=System.currentTimeMillis();
		assertThat(new WordSearchInBoardBFS().findWords(new char[][]{				
				  {'a','b'},
				  {'a','a'}		
